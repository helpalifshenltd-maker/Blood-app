...
object MockData {
    ...
    val initialRegisteredHospitals = listOf(
        ...
        RegisteredHospital(
            id = "hosp_usa_1",
            name = "Mount Sinai Hospital & Health Center",
            type = "Hospital & Diagnostic",
            address = "1468 Madison Ave, New York, NY 10029",
            district = "New York",
            upazila = "Manhattan",
            phone = "+1 (212) 241-6500",
            email = "contact@mountsinai.org",
            website = "https://mountsinai.org",
            logoUrl = "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=300&auto=format&fit=crop&q=80",
            photoUrl = "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=600&auto=format&fit=crop&q=80",
            services = "24/7 Level 1 Trauma, ICU, CCU, Advanced MRI, Cardiology, Organ Transplant",
            bloodAvailability = "Full Blood Bank Stock Available",
            planType = "Premium (Yearly)",
            subscriptionExpiryDate = "2027-12-31",
            isApproved = true,
            isFeatured = true,
            urgentNotice = "⭐ World-Class Care & Emergency Trauma Center",
            whatsappNumber = "+12122416500",
            country = "USA",
            paymentMethod = "Google Pay",
            paymentTxnId = "US99887766",
        ...
        RegisteredHospital(
            ...
            email = "info@hopkinsmedicine.org",
            website = "https://hopkinsmedicine.org",
            logoUrl = "https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=300&auto=format&fit=crop&q=80",
            photoUrl = "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=600&auto=format&fit=crop&q=80",
            services = "Pediatric Care, Oncology, ICU, Robotic Surgery, Blood Transfusion",
            bloodAvailability = "All Rare Blood Groups Available",
            planType = "Premium (Monthly)",
            subscriptionExpiryDate = "2026-12-31",
            isApproved = true,
            isFeatured = true,
            urgentNotice = "🔬 Special Consultation & Diagnostic Discounts",
            whatsappNumber = "+14109555000",
            country = "USA",
            paymentMethod = "Wise",
            paymentTxnId = "US77665544",
        ...
        RegisteredHospital(
            ...
            email = "care@houstonmethodist.org",
            website = "https://houstonmethodist.org",
            logoUrl = "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=300&auto=format&fit=crop&q=80",
            photoUrl = "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=600&auto=format&fit=crop&q=80",
            services = "Cardiology, Neurology, Orthopedics, ICU, Urgent Care",
            bloodAvailability = "Emergency Donor Support Available",
            planType = "Free",
            subscriptionExpiryDate = "Lifetime Free",
            isApproved = true,
            isFeatured = false,
            urgentNotice = "",
            whatsappNumber = "+17137903311",
            country = "USA",
            paymentMethod = "Free",
            paymentTxnId = "FREE_PLAN",
            registrationDate = "2026-07-01"
    ...
    val initialDoctors = listOf(
        RegisteredDoctor(
            ...
            titleDegree = "MBBS, FCPS (Medicine), MD (Cardiology)",
            specialty = "Cardiologist",
            hospitalName = "Dhaka Medical College Hospital",
            chamberAddress = "Room 304, Green Life Hospital, Dhanmondi, Dhaka",
            district = "Dhaka",
            upazila = "Dhanmondi",
            phone = "01711223388",
            email = "dr.hasan@med.com",
            visitingHours = "5:00 PM - 9:00 PM (Sat - Thu)",
            consultationFee = "800 BDT",
            isApproved = true,
            regType = "General",
            country = "Bangladesh"
        ),
        RegisteredDoctor(
            ...
            titleDegree = "MBBS, FCPS (Gynecology & Obstetrics)",
            specialty = "Gynecologist",
            hospitalName = "Square Hospital Ltd",
            chamberAddress = "Labaid Diagnostic, Gulshan, Dhaka",
            district = "Dhaka",
            upazila = "Gulshan",
            phone = "01811998822",
            email = "dr.nusrat@hospital.com",
            visitingHours = "4:00 PM - 8:00 PM (Sun - Wed)",
            consultationFee = "1000 BDT",
            isApproved = true,
            regType = "General",
            country = "Bangladesh"
        ),
        RegisteredDoctor(
            ...
            titleDegree = "MBBS, DCH (Pediatrics), FCPS (Child)",
            specialty = "Pediatrics",
            hospitalName = "Chattogram Medical College Hospital",
            chamberAddress = "Chittagong Consultation Center, GEC Circle",
            district = "Chattogram",
            upazila = "Panchlaish",
            phone = "01911445566",
            email = "dr.rakib@childcare.com",
            visitingHours = "6:00 PM - 9:00 PM (Daily)",
            consultationFee = "700 BDT",
            isApproved = true,
            regType = "General",
            country = "Bangladesh"
        ),
        RegisteredDoctor(
            ...
            titleDegree = "MBBS, MS (Orthopedics Surgery)",
            specialty = "Orthopedics",
            hospitalName = "Sylhet MAG Osmani Medical College Hospital",
            chamberAddress = "Popular Diagnostic Center, Zindabazar, Sylhet",
            district = "Sylhet",
            upazila = "Sylhet Sadar",
            phone = "01722334411",
            email = "dr.tanvir@ortho.com",
            visitingHours = "5:00 PM - 8:30 PM (Sat - Wed)",
            consultationFee = "600 BDT",
            isApproved = true,
            regType = "General",
            country = "Bangladesh"
        ),
        RegisteredDoctor(
            ...
            titleDegree = "MBBS, FCPS (Medicine)",
            specialty = "Medicine",
            hospitalName = "Rajshahi Medical College Hospital",
            chamberAddress = "Medinova Medical Services, Laxmipur, Rajshahi",
            district = "Rajshahi",
            upazila = "Boalia",
            phone = "01833445566",
            email = "dr.shamima@rmch.com",
            visitingHours = "4:00 PM - 8:00 PM (Sat - Thu)",
            consultationFee = "500 BDT",
            isApproved = true,
            regType = "General",
            country = "Bangladesh"
        ),
        RegisteredDoctor(
            ...
            titleDegree = "MD, FACC (Cardiology)",
            specialty = "Cardiology",
            hospitalName = "Johns Hopkins Hospital",
            chamberAddress = "Suite 402, Orleans St, Baltimore, MD",
            district = "Maryland",
            upazila = "Baltimore",
            phone = "+1 (410) 955-1234",
            email = "mcarter@hopkins.org",
            visitingHours = "9:00 AM - 4:00 PM (Mon - Fri)",
            consultationFee = "$150",
            isApproved = true,
            regType = "General",
            country = "USA"
        ...
        RegisteredDoctor(
            id = "doc_usa_2",
            name = "Dr. Emily R. Davis",
            titleDegree = "MD, PhD (Neurology & Brain Health)",
            specialty = "Neurology",
            hospitalName = "Mount Sinai Hospital & Health Center",
            chamberAddress = "1468 Madison Ave, New York, NY 10029",
            district = "New York",
            upazila = "Manhattan",
            phone = "+1 (212) 241-9876",
            email = "edavis@mountsinai.org",
            visitingHours = "10:00 AM - 5:00 PM (Tue - Sat)",
            consultationFee = "$200",
            isApproved = true,
            regType = "General",
            country = "USA"
        ...
        RegisteredDoctor(
            ...
            titleDegree = "MD, FAAP (Pediatrics)",
            specialty = "Pediatrics",
            hospitalName = "Houston Methodist Hospital",
            chamberAddress = "6565 Fannin St, Houston, TX 77030",
            district = "Texas",
            upazila = "Houston",
            phone = "+1 (713) 790-8888",
            email = "rjohnson@houstonmethodist.org",
            visitingHours = "8:30 AM - 3:30 PM (Mon - Thu)",
            consultationFee = "$120",
            isApproved = true,
            regType = "General",
            country = "USA"
